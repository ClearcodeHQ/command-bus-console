...
use ClearcodeHQ\CommandBusLauncherBundle\Launcher\ValueConverter\IntConverter;
use ClearcodeHQ\CommandBusLauncherBundle\Launcher\ValueConverter\UuidConverter;
...
class CommandReflectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @test
     * @expectedException \ClearcodeHQ\CommandBusLauncherBundle\Launcher\MissingCommandArgument
     */
    ...
    /**
     * @test
     * @expectedException \ClearcodeHQ\CommandBusLauncherBundle\Launcher\InvalidCommandArgument
     */
